...
public static class AssetPackUISetup
{
    ...
    public static void Apply()
    {
        ...
        var burgerText = CreateText(sidebar.transform, "Text_BurgerCount", "BURGER 0/100", new Vector2(18f, -18f), new Vector2(170f, 24f), 16f);
        var statusText = CreateText(sidebar.transform, "Text_Status", "STATUS Ready", new Vector2(18f, -45f), new Vector2(170f, 20f), 12f);
        var timerText = CreateText(sidebar.transform, "Text_Timer", "00:00", new Vector2(18f, -68f), new Vector2(120f, 22f), 14f);
        var lastMessageText = CreateText(sidebar.transform, "Text_LastMessage", "Message", new Vector2(18f, -94f), new Vector2(178f, 30f), 11f);
        var promptText = CreateText(sidebar.transform, "Text_Prompt", "Prompt", new Vector2(18f, -128f), new Vector2(178f, 22f), 11f);
        var heldItemText = CreateText(sidebar.transform, "Text_HeldItem", "Hand -", new Vector2(18f, -152f), new Vector2(178f, 18f), 10f);
        var inventoryText = CreateText(sidebar.transform, "Text_Inventory", "Inv -", new Vector2(18f, -172f), new Vector2(178f, 18f), 10f);
        ...
        if (hud != null)
        {
            ...
            type.GetField("burgerCountText")?.SetValue(hud, burgerText);
            type.GetField("heldItemText")?.SetValue(hud, heldItemText);
            type.GetField("promptText")?.SetValue(hud, promptText);
            type.GetField("inventoryText")?.SetValue(hud, inventoryText);
    ...
    static GameObject CreateSidebar(Transform hudRoot, Sprite sprite)
    {
        ...
        rt.sizeDelta = new Vector2(310f, 210f);
        rt.localScale = Vector3.one;
    ...
    static GameObject EnsureButtons(Transform canvas)
    {
        ...
        img.type = Image.Type.Sliced;
        img.color = new Color(0.12f, 0.12f, 0.14f, 0.90f);
        img.raycastTarget = false;
